...
export function handleFileUploaded(event: FileUploadedEvent): void {
  ...
  entity.storageNodeId = event.params.storageNodeId
...
export function handleStorageNodeDeactivated(
  event: StorageNodeDeactivatedEvent
): void {
  let entity = new StorageNodeDeactivated(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.owner = event.params.owner
  entity.nodeId = event.params.nodeId
...
export function handleStorageNodeUpdated(event: StorageNodeUpdatedEvent): void {
  let entity = new StorageNodeUpdated(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.owner = event.params.owner
  entity.nodeId = event.params.nodeId
  entity.usedSpace = event.params.usedSpace
